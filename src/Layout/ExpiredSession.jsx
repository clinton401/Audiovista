...
function ExpiredSession({ setExpiredToken, getTokenHandler }) {
  return (
    <div className="flex items-center transition-all ease-in duration-300  ipad:right-5 justify-center px-[2%] z-50  top-0   fixed w-full h-full blurred ipad:max-h-[900px] artist_fixed_width ">
